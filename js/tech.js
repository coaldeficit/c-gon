const tech = {
    ...
    //     }
    // },
    aproxJunkRatio: 0, // c-gon uses an older junk system from before a proper junk chance, this is to allow junk DNA to work
    addJunkTechToPool(chance) { //chance is number between 0-1
        ...
        //     console.log(count)
        // }
        tech.aproxJunkRatio += chance
        if (tech.aproxJunkRatio < 0.001 || tech.aproxJunkRatio === undefined) tech.aproxJunkRatio = 0
    ...
    hasExplosiveDamageCheck() {
        return tech.haveGunCheck("missiles") || tech.isMissileField || tech.missileBotCount > 0 || tech.boomBotCount > 1 || tech.isIncendiary || tech.isPulseLaser || tech.isTokamak || (tech.haveGunCheck("grenades") && !tech.isNeutronBomb) || tech.isWhitePhosphorus || tech.isShotgunFireEverything || tech.isExplodeContact
    },
    ...
    damageFromTech() {
        ...
        if (tech.isAxion && tech.isHarmMACHO) dmg *= 1 + (0.75*(tech.isInvertMACHO ? 1.6 : 1)*(tech.isPullMACHO ? 1.2 : 1)) * Math.max(0,1 - m.harmReduction())
        ...
        if (tech.isAbelian && m.immuneCycle >= m.cycle) dmg *= 2.2
        ...
        if (tech.isMartingale) dmg *= 1 + tech.martingaleDamage
    ...
    tech: [
	  {
        ...
        },
        {
            ...
            description: "<strong>double</strong> your current permanent <strong class='color-bot'>bots</strong><br><strong class='color-remove'>remove</strong> <strong>all</strong> <strong class='color-g'>guns</strong> in your inventory",
            maxCount: 1,
            count: 0,
            frequency: 2,
            frequencyDefault: 2,
    ...
    /*{
        ...
        },
        {
            ...
            description: `after receiving <strong class='color-harm'>harm</strong> from a <strong>collision</strong> become<br><strong class='color-invulnerable'>invulnerable</strong> for <strong>2.5</strong> extra seconds`,
            maxCount: 9,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
        ...
        },
        {
            ...
            description: `become <strong class='color-invulnerable'>invulnerable</strong> for <strong>1.75</strong> seconds<br>once every <strong>7</strong> seconds`,
            maxCount: 3,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
        ...
        {
            name: "fermion",
            description: `after a mob <strong>dies</strong><br>become <strong class='color-invulnerable'>invulnerable</strong> for <strong>1.5</strong> seconds`,
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
            ...
            remove() {
                tech.isFermion = false;
            }
        },
        {
            name: "abelian group",
            description: `increase <strong class='color-d'>damage</strong> by <strong>120%</strong><br>while <strong class='color-invulnerable'>invulnerable</strong>`,
            maxCount: 1,
            count: 0,
            frequency: 3,
            frequencyDefault: 3,
        ...
        {
            name: "dark matter",
            description: "<strong class='color-dark-matter'>dark matter</strong> slowly <strong>follows</strong> you<br>take <strong>66%</strong> less <strong class='color-harm'>harm</strong> inside it's <strong>halo</strong>",
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
        ...
        {
            name: "axion",
            description: "while inside <strong class='color-dark-matter'>dark matter</strong> <strong>75%</strong> of your total<br><strong class='color-harm'>harm</strong> reduction is added to your <strong class='color-d'>damage</strong>",
            maxCount: 1,
            count: 0,
            frequency: 2,
            frequencyDefault: 2,
        ...
        {
            name: "dark energy",
            description: "while inside <strong class='color-dark-matter'>dark matter</strong><br>generate <strong>10</strong> <strong class='color-f'>energy</strong> per second",
            maxCount: 1,
            count: 0,
            frequency: 2,
            frequencyDefault: 2,
        ...
        {
            name: "MACHO",
            description: "the <strong>effects</strong> of <strong class='color-dark-matter'>dark matter</strong> are only active <strong>outside</strong> of it<br><strong class='color-dark-matter'>dark matter</strong> effects are boosted by <strong>60%</strong>",
            maxCount: 1,
            count: 0,
            frequency: 2,
            frequencyDefault: 2,
            allowed() {
                return tech.isMACHO && !tech.isPullMACHO && !tech.isMobDamageMACHO
            },
            requires: "dark matter, not entropic gravity, dark star",
            effect: () => {
                tech.isInvertMACHO = true
            },
            remove() {
                tech.isInvertMACHO = false
            }
        },
        {
            name: "entropic gravity",
            description: "<strong>crouching</strong> pulls <strong class='color-dark-matter'>dark matter</strong> towards you<br><strong class='color-dark-matter'>dark matter</strong> effects are boosted by <strong>20%</strong>",
            maxCount: 1,
            count: 0,
            frequency: 2,
            frequencyDefault: 2,
            allowed() {
                return tech.isMACHO && !tech.isInvertMACHO && !tech.isMobDamageMACHO
            },
            requires: "dark matter, not MACHO, dark star",
            effect: () => {
                tech.isPullMACHO = true
            },
            remove() {
                tech.isPullMACHO = false
            }
        },
        {
            name: "dark star",
            description: "<strong class='color-dark-matter'>dark matter</strong> <strong class='color-d'>damages</strong> mobs <strong>inside</strong> of it<br>increase <strong class='color-dark-matter'>dark matter</strong> <strong>radius</strong> by <strong>30%</strong>",
            maxCount: 1,
            count: 0,
            frequency: 2,
            frequencyDefault: 2,
            allowed() {
                return tech.isMACHO && !tech.isInvertMACHO && !tech.isPullMACHO
            },
            requires: "dark matter, not MACHO, entropic gravity",
            effect: () => {
                tech.isMobDamageMACHO = true
            },
            remove() {
                tech.isMobDamageMACHO = false
            }
        },
        {
        ...
        },
        {
            ...
            description: `<strong class='color-e'>explode</strong> after mob <strong>collisions</strong><br><em>exploding doesn't cause harm</em>`,
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
            allowed() {
                return !tech.isSmartRadius
            },
            requires: "not controlled explosion",
            effect() {
        ...
        },
        {
            ...
            frequencyDefault: 1,
            allowed() {
                return !tech.isDamageAfterKillNoRegen && !tech.isFurnace
            },
            requires: "not parasitism, not furnace",
            effect() {
        ...
        {
            name: "furnace",
            description: `passive <strong class='color-f'>energy</strong> regeneration is increased by <strong>550%</strong><br>slowly <strong>drains</strong> <strong class='color-r'>research</strong> or <strong class='color-h'>health</strong><br> spawn ${powerUps.orb.research(8)}`,
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
            allowed() {
                return !tech.isCrouchRegen && !tech.isDamageAfterKillNoRegen
            },
            requires: "not inductive coupling, not parasitism",
            effect: () => {
                tech.isFurnace = true
                m.regenEnergy = function() {
                    if (m.immuneCycle < m.cycle) m.energy += m.fieldRegen
                    m.energy += m.fieldRegen*5.5
                    if (m.energy < 0) m.energy = 0
                }
		for (let i = 0; i < 8; i++) powerUps.spawn(m.pos.x + Math.random() * 60, m.pos.y + Math.random() * 60, "research", false)
            },
            remove() {
                tech.isFurnace = false
		m.regenEnergy = m.regenEnergyDefault
            }
        },
        {
        ...
        },
        {
            ...
            frequencyDefault: 1,
            allowed() {
                return !tech.isCrouchRegen && !tech.isFurnace
            },
            requires: "not inductive coupling, not furnace",
            effect() {
        ...
        {
            name: "stability",
            description: "reduce <strong class='color-harm'>harm</strong> by <strong>67%</strong><br>while you are at full <strong class='color-h'>health</strong>",
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
            allowed() {
                return !tech.isInstability
            },
            requires: "not instability",
            effect() {
                tech.isStability = true;
            },
            remove() {
                tech.isStability = false;
            }
        },
        {
            name: "instability",
            description: "increase <strong class='color-d'>damage</strong> by <strong>100%</strong><br>while your <strong class='color-harm'>harm</strong> reduction is below <strong>35%</strong>",
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
            allowed() {
                return !tech.isStability
            },
            requires: "not stability",
            effect() {
                tech.isInstability = true;
            },
            remove() {
                tech.isInstability = false;
            }
        },
        {
            name: "control theory",
            description: "increase <strong class='color-d'>damage</strong> by <strong>67%</strong><br>while you are at full <strong class='color-h'>health</strong>",
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
            ...
            requires: "",
            effect() {
                tech.isControlTheory = true;
            },
            remove() {
                tech.isControlTheory = false;
            }
        },
        {
            name: "homeostasis",
            descriptionFunction() {
                ...
                return `missing <strong class='color-h'>health</strong> reduces <strong class='color-harm'>harm</strong><br>by up to <strong>${Math.round((1-scale)*100)}%</strong> at <strong>0</strong> <strong class='color-h'>health</strong><em style ="float: right;">(${Math.round((1-(0.2+((m.health/m.maxHealth)*0.8)))*100)}%)</em>`
            },
            maxCount: 1,
            count: 0,
            frequency: 2,
        ...
        },
        {
            name: "accretion",
            descriptionFunction() {
                return `${powerUps.orb.heal(1)} follow you, even between levels<br>${powerUps.orb.heal()} are <strong>50%</strong> less effective`
            },
            maxCount: 1,
            count: 0,
            frequency: 1,
        ...
        },
        {
            name: "accretion disk",
            descriptionFunction() {
                return `increase <strong class='color-d'>damage</strong> by <strong>4%</strong> for each <strong>power up</strong> on this <strong>level</strong><br><strong>+11%</strong> <strong class='color-j'>JUNK</strong> to the potential <strong class='color-m'>tech</strong> pool <em style ="float: right;">(${7 * powerUp.length}%)</em>`
            },
            maxCount: 1,
            count: 0,
            frequency: 2,
        ...
        {
            name: "ansatz",
            description: `after choosing a <strong class='color-f'>field</strong>, <strong class='color-m'>tech</strong>, or <strong class='color-g'>gun</strong><br>spawn ${powerUps.orb.research(3)}if you have no ${powerUps.orb.research(1)} in your inventory`,
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
        ...
        {
            name: "a priori",
            description: `after <strong>choosing</strong> a <strong class='color-f'>field</strong> or <strong class='color-g'>gun</strong><br>get a compatible <strong class='color-f'>field</strong> or <strong class='color-g'>gun</strong> <strong class='color-m'>tech</strong>`,
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
        ...
        {
            name: "paradigm shift",
            description: `<strong>clicking</strong> <strong class='color-m'>tech</strong> while paused <strong class='color-remove'>ejects</strong> them<br><strong>10%</strong> chance to convert that <strong class='color-m'>tech</strong> into ${powerUps.orb.research(1)}`,
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
            ...
            effect() {
                ...
                for (let i = 0, len = tech.tech.length; i < len; i++) {
                    if (tech.tech[i].isRemoveTech) tech.tech[i].frequency *= 2
                }
            },
            remove() {
        ...
        {
            name: "strange loop",
            description: "<strong class='color-remove'>removing</strong> this gives a random <strong class='color-remove'>remove</strong> <strong class='color-m'>tech</strong><br><span style = 'font-size:80%;'>increase <strong class='color-d'>damage</strong> by <strong>10%</strong></span>",
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
            ...
            remove() {
                if (this.count > 0 && m.alive) {
                    ...
                    requestAnimationFrame(() => {
                        const options = []
                        for (let i = 0, len = tech.tech.length; i < len; i++)    if (tech.tech[i].isRemoveTech && tech.tech[i].count === 0) options.push(i)
                        const index = options[Math.floor(Math.random() * options.length)]
                        tech.giveTech(tech.tech[index].name)
                    });
                } else {
                    tech.removeTechDamage = 1
                }
            }
        },
        {
            name: "null hypothesis",
            description: `<strong class='color-remove'>removing</strong> this spawns ${powerUps.orb.research(10)}<br><span style = 'font-size:80%;'>increase <strong class='color-d'>damage</strong> by <strong>10%</strong></span>`,
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
            ...
            remove() {
                if (this.count > 0 && m.alive) {
                    ...
                    requestAnimationFrame(() => {
                        for (let i=0;i<10;i++) powerUps.spawn(m.pos.x, m.pos.y, "research");
                    });
                } else {
                    tech.removeTechDamage = 1
                }
        ...
        },
        {
            name: "martingale",
            descriptionFunction() {
                return `increase <strong class='color-d'>damage</strong> by <strong>${Math.round(tech.martingaleDamage*100)}%</strong>, but has a <strong>50%</strong> chance<br>to return with <strong>doubled</strong> <strong class='color-d'>damage</strong> on <strong class='color-remove'>removal</strong>`
            },
            maxCount: 1,
            count: 0,
            frequency: 1,
            ...
            isRemoveTech: true,
            isBadRandomOption: true,
            allowed() { return !tech.isBanish },
            requires: "not decoherence",
            effect() {
                tech.isMartingale = true
            },
            remove() {
                tech.isMartingale = false
                if (this.count > 0 && m.alive) {
                    tech.martingaleDamage *= 2
                    requestAnimationFrame(() => {
                        if (Math.random() < 0.5) {
                    ...
                    tech.martingaleDamage = 0.1
                }
            }
        },
        {
            name: "arms trade",
            description: "<strong class='color-remove'>removing</strong> this spawns <strong>4</strong> <strong class='color-g'>guns</strong><br><span style = 'font-size:80%;'>increase <strong class='color-d'>damage</strong> by <strong>10%</strong></span>",
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
            ...
            remove() {
                if (this.count > 0 && m.alive) {
                    ...
                    requestAnimationFrame(() => {
                        for (let i=0;i<4;i++) powerUps.spawn(m.pos.x, m.pos.y, "gun");
                    });
                } else {
                    tech.removeTechDamage = 1
                }
        ...
        {
            name: "externality",
            description: `<strong class='color-remove'>removing</strong> this spawns ${powerUps.orb.ammo(12)}<br><span style = 'font-size:80%;'>increase <strong class='color-d'>damage</strong> by <strong>10%</strong></span>`,
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
            ...
            remove() {
                if (this.count > 0 && m.alive) {
                    ...
                    requestAnimationFrame(() => {
                        for (let i=0;i<12;i++) powerUps.spawn(m.pos.x, m.pos.y, "ammo");
                    });
                } else {
                    tech.removeTechDamage = 1
                }
        ...
        {
            name: "ectomy",
            description: `<strong class='color-remove'>removing</strong> this spawns ${powerUps.orb.heal(15)}<br><span style = 'font-size:80%;'>increase <strong class='color-d'>damage</strong> by <strong>10%</strong></span>`,
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
            ...
            remove() {
                if (this.count > 0 && m.alive) {
                    ...
                    requestAnimationFrame(() => {
                        for (let i=0;i<15;i++) powerUps.spawn(m.pos.x, m.pos.y, "heal");
                    });
                } else {
                    tech.removeTechDamage = 1
                }
        ...
        },
        {
            name: "deprecated",
            descriptionFunction() {
                return `after <strong class='color-remove'>removing</strong> this, increase <strong class='color-d'>damage</strong> by <strong>10%</strong><br>for every <strong class='color-m'>tech</strong> <strong class='color-remove'>removed</strong> this game<em style ="float: right;">(${Math.round(tech.removeCount*10)}%)</em>`
            },
            maxCount: 1,
            count: 0,
            frequency: 1,
            ...
            remove() {
                if (this.count > 0 && m.alive) {
                    requestAnimationFrame(() => {
                        tech.removeTechDamage *= 1+(Math.max(0,tech.removeCount-1)*0.1)
                        this.frequency = 0
                    });
                } else {
                    tech.removeTechDamage = 1
        ...
        },
        {
            ...
            description: "<strong class='color-remove'>eject</strong> your highest <strong class='color-m'>tech</strong> at the start of each <strong>level</strong><br>and increase <strong class='color-d'>damage</strong> by <strong>10%</strong> each time",
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
            ...
            requires: "",
            effect() {
                tech.isEjectHighestTech = true
            },
            remove() {
                tech.isEjectHighestTech = false
            }
        },
        {
        ...
        },
        {
            name: "junk DNA",
            descriptionFunction() {
                return `increase <strong class='color-d'>damage</strong> by your <strong class='color-j'>JUNK</strong> chance<em style ="float: right;">(${Math.round(tech.aproxJunkRatio*100)}%)</em>`
            },
            maxCount: 1,
            count: 0,
            frequency: 1,
        ...
        {
            name: "ergodicity",
            description: `reduce combat <strong>difficulty</strong> by <strong>2 levels</strong><br>${powerUps.orb.heal()} are <strong>50%</strong> less effective`,
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
        ...
        },
        {
            ...
            description: "clicking <strong style = 'font-size:150%;'>×</strong> to <strong>cancel</strong> a <strong class='color-f'>field</strong>, <strong class='color-m'>tech</strong>, or <strong class='color-g'>gun</strong><br>adds <strong>1.2%</strong> power up <strong class='color-dup'>duplication</strong> chance",
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
        ...
        },
        {
            ...
            description: "<strong>30%</strong> chance to <strong class='color-dup'>duplicate</strong> spawned <strong>power ups</strong><br>but, after a <strong>collision</strong> <strong class='color-remove'>eject</strong> <strong>1</strong> <strong class='color-m'>tech</strong>",
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
        ...
        {
            name: "Born rule",
            description: "<strong class='color-remove'>remove</strong> all current <strong class='color-m'>tech</strong><br>spawn new <strong class='color-m'>tech</strong> to replace them",
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
        ...
        },
        {
            ...
            // },
            descriptionFunction() {
                return `randomly <strong class='color-remove'>remove</strong> <strong>half</strong> your <strong class='color-m'>tech</strong><br>for each <strong class='color-remove'>removed</strong> gain <strong>${this.damagePerRemoved * 100}%</strong> <strong class='color-d'>damage</strong> <em>(~${this.damagePerRemoved * 50 * tech.totalCount}%)</em>`
            },
            maxCount: 1,
            count: 0,
            frequency: 1,
        ...
        },
        {
            ...
            description: "<strong class='color-remove'>remove</strong> <strong>1</strong> random <strong class='color-m'>tech</strong><br>spawn <strong>2</strong> new <strong class='color-g'>guns</strong>",
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
        ...
        },
        {
            ...
            description: "<strong class='color-remove'>remove</strong> <strong>1</strong> random <strong class='color-m'>tech</strong><br>spawn <strong>2</strong> <strong class='color-m'>tech</strong>",
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
        ...
        },
        {
            ...
            description: "gain <strong class='color-harm'>harm</strong> reduction over time capped at <strong>100%</strong><br>lose <strong>20%</strong> <strong class='color-harm'>harm</strong> reduction on hit<br>all other <strong class='color-harm'>harm</strong> reduction ignored",
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
        ...
        },
        {
            ...
            description: "become <strong class='color-invulnerable'>invulnerable</strong> while firing the <strong>shotgun</strong><br>shotgun has <strong>33%</strong> fewer shots",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 2,
            frequencyDefault: 2,
            allowed() {
                return tech.haveGunCheck("shotgun") && !tech.isShotgunHeat
            },
            requires: "shotgun, not heat pipe",
            effect() {
                ...
                for (i = 0, len = b.guns.length; i < len; i++) { //find which gun 
                    if (b.guns[i].name === "shotgun") {
                        ...
                        b.guns[i].ammoPack = b.guns[i].defaultAmmoPack * 0.6
                        break;
                    }
                }
                simulation.updateGunHUD();
            ...
            remove() {
                if (tech.isShotgunImmune) {
                    ...
                    for (i = 0, len = b.guns.length; i < len; i++) { //find which gun 
                        if (b.guns[i].name === "shotgun") {
                            b.guns[i].ammoPack = b.guns[i].defaultAmmoPack;
                            b.guns[i].ammo = Math.ceil(b.guns[i].ammo * 1.667);
                            break;
                        }
                    }
                    simulation.updateGunHUD();
        ...
        },
        {
            ...
            frequencyDefault: 2,
            allowed() {
                return tech.haveGunCheck("shotgun") && !tech.isShotgunReversed && !tech.isShotgunFlak
            },
            requires: "shotgun, not Noether violation, flak",
            effect() {
        ...
        },
        {
            ...
            frequencyDefault: 2,
            allowed() {
                return (tech.haveGunCheck("shotgun")) && !tech.isShotgunRecoil && !tech.isShotgunFlak
            },
            requires: "shotgun, not Newton's 3rd law, flak",
            effect() {
        ...
        {
            name: "flak",
            description: "<strong>shotgun</strong> fires <strong>400%</strong> faster in a <strong>narrower</strong> arc<br>shotgun fires <strong>50%</strong> fewer projectiles",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 2,
            frequencyDefault: 2,
            allowed() {
                return tech.haveGunCheck("shotgun") && !tech.isShotgunReversed && !tech.isShotgunRecoil
            },
            requires: "shotgun, not Newton's 3rd law, Noether violation",
            effect() {
                tech.isShotgunFlak = true
            },
            remove() {
                tech.isShotgunFlak = false;
            }
        },
        {
            name: "ricochet",
            description: "<strong>shotgun</strong> projectiles sometimes <strong>rebound</strong><br>towards nearby mobs on <strong>collision</strong>",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 2,
            frequencyDefault: 2,
            allowed() {
                return tech.haveGunCheck("shotgun") && !tech.hasShotgunBulletReplacementCheck()
            },
            requires: "shotgun, no shotgun bullet replacement tech",
            effect() {
                tech.isShotgunBounce = true
            },
            remove() {
                tech.isShotgunBounce = false;
            }
        },
        {
            name: "heat pipe",
            description: "<span style = 'font-size:95%;'><strong>shotgun</strong> builds up <strong class='color-e'>heat</strong> while not firing<br><strong class='color-e'>heat</strong> decreases <strong><em>delay</em></strong> after firing by up to <strong>90%</strong></span>",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 2,
        ...
        },
        {
            ...
            description: "gain a <strong class='color-bot'>bot</strong> that fires <strong>missiles</strong> at mobs<br><strong class='color-remove'>remove</strong> your <strong>missile gun</strong>",
            isGunTech: true,
            isRemoveGun: true,
            maxCount: 1,
            count: 0,
        ...
        },
        {
            ...
            frequencyDefault: 2,
            allowed() {
                return tech.explosiveRadius === 1 && !tech.isSmallExplosion && (tech.haveGunCheck("missiles") || tech.missileBotCount || tech.isIncendiary || (tech.haveGunCheck("grenades") && !tech.isNeutronBomb) || tech.isPulseLaser || tech.isMissileField || tech.boomBotCount > 1 || tech.isTokamak || tech.isWhitePhosphorus || tech.isShotgunFireEverything || tech.isExplodeContact)
            },
        ...
        // },
        {
            ...
            frequencyDefault: 2,
            allowed() {
                return !tech.isImmuneExplosion && !tech.isExplodeContact && (build.isExperimentSelection || powerUps.research.count > 2) && (tech.haveGunCheck("missiles") || tech.isMissileField || tech.missileBotCount > 0 || tech.isIncendiary || tech.isPulseLaser || tech.isTokamak || (tech.haveGunCheck("grenades") && !tech.isNeutronBomb) || tech.isWhitePhosphorus || tech.isShotgunFireEverything)
            },
            requires: "an explosive damage source, not electric reactive armor, contact explosive",
            effect: () => {
        ...
        },
        {
            ...
            description: "spawn <strong>6</strong> <strong>drones</strong> that last <strong>forever</strong><br><strong class='color-remove'>remove</strong> your <strong>drone gun</strong>",
            isGunTech: true,
            isRemoveGun: true,
            maxCount: 1,
            count: 0,
        ...
        },
        {
            ...
            isBotTech: true,
            isNonRefundable: true,
            requires: "at least 3 guns, foam gun, NOT EXPERIMENT MODE, bot upgrades, fractionation, quantum foam, capacitor, Plateau's",
            allowed() {
                return b.inventory.length > 2 && tech.haveGunCheck("foam", false) && !b.hasBotUpgrade() && !tech.isAmmoFoamSize && !tech.foamFutureFire && !tech.isCapacitor && !tech.isFoamChargeBuff
            },
            effect() {
                tech.giveTech("foam-bot upgrade")
                for (let i = 0; i < 2; i++) {
        ...
        {
            name: "syntactic foam",
            description: "<strong>foam</strong> bubbles do <strong>100%</strong> extra <strong class='color-d'>damage</strong> on<br><strong>collision</strong>, but do <strong>50%</strong> less <strong class='color-d'>damage</strong> total",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 2,
            ...
            effect() {
                tech.isFoamImpact = true
            },
            remove() {
                tech.isFoamImpact = false
            }
        },
        {
            name: "Plateau's laws",
            description: "charging up your <strong>foam</strong> gun grants <strong>7%</strong><br>increased <strong>foam</strong> <strong class='color-d'>damage</strong> per spent <strong class='color-ammo'>ammo</strong>",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 2,
            frequencyDefault: 2,
            allowed() {
                return !tech.isCapacitor && tech.haveGunCheck("foam")
            },
            requires: "foam gun, not capacitor bank",
            effect() {
                tech.isFoamChargeBuff = 1
            },
            remove() {
                tech.isFoamChargeBuff = 0
            }
        },
        {
            name: "sodium laureth sulfate",
            description: "<strong>foam</strong> bubbles grow <strong>copies</strong> as they travel",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 2,
            frequencyDefault: 2,
            allowed() {
                return !tech.isSpawnBulletsOnDeath && (tech.haveGunCheck("foam") || tech.foamBotCount > 1)
            },
            requires: "foam other than foam-shot, not necrophage",
            effect() {
                tech.isFoamCloneWhileTravel = true
            },
            remove() {
                tech.isFoamCloneWhileTravel = false
            }
        },
        {
            name: "capacitor bank",
            ...
            frequencyDefault: 2,
            allowed() {
                return (tech.blockDamage > 0.075 || tech.isRailGun || tech.haveGunCheck("foam") || tech.isTokamak || tech.isPulseLaser || tech.isPlasmaBall) && !tech.isFoamChargeBuff
            },
            requires: "throwing blocks, railgun, foam, pulse, tokamak, plasma ball, not Plateau's laws",
            effect() {
        ...
        },
        {
            ...
            frequencyDefault: 2,
            allowed() {
                return m.fieldUpgrades[m.fieldMode].name === "perfect diamagnetism" && !tech.isHealBrake
            },
        ...
        },
        {
            ...
            description: "<strong class='color-remove'>remove</strong> your <strong>field</strong> to build a <strong class='color-bot'>bot</strong><br>that uses <strong class='color-f'>energy</strong> to emit <strong class='color-plasma'>plasma</strong>",
            isFieldTech: true,
            maxCount: 1,
            count: 0,
            frequency: 3,
        ...
        {
            name: "WIMPs",
            description: `at the end of each <strong>level</strong> spawn ${powerUps.orb.research(4)}<br> and a <strong class='color-harm'>harmful</strong> particle that slowly <strong>chases</strong> you`,
            isFieldTech: true,
            maxCount: 9,
            count: 0,
            frequency: 1,
        ...
        {
            name: "anyon",
            description: "<strong>double</strong> your <strong class='color-f'>energy</strong> after <strong class='color-dup'>duplicating</strong> a power up<br><strong class='color-f'>energy</strong> above your max decays <strong>instantly</strong>",
            isFieldTech: true,
            maxCount: 1,
            count: 0,
            frequency: 3,
        ...
        },
        {
            ...
            description: "increase your <strong>maximum</strong> <strong class='color-h'>health</strong> by <strong>150</strong><br>but receive <strong class='color-harm'>harm</strong> while not beneath <strong>low ceilings</strong>",
            isFieldTech: true,
            maxCount: 1,
            count: 0,
            frequency: 2,
            ...
            isHealTech: true,
            allowed() {
                return (m.fieldUpgrades[m.fieldMode].name === "time dilation" || m.fieldUpgrades[m.fieldMode].name === "wormhole") && !tech.isEnergyHealth && !tech.isRewindField
            },
            requires: "time dilation, wormhole, not mass-energy equivalence, retrocausality",
            effect() {
                tech.isPhotodisintegration = true;
                m.setMaxHealth();
                m.addHealth(1.5 / simulation.healScale)
            },
            remove() {
                tech.isPhotodisintegration = false;
                m.setMaxHealth();
            }
        },
		// special mode garbage
        {
            ...
            requires: "☆ S P E C I A L ☆ difficulty",
            effect() {
                level.difficultyDecrease((simulation.difficultyMode * 2) - 1)
				m.health *= 0.3
            },
            remove() {}
        },
        ...
        },
        {
            ...
            effect() {
                ...
                let effects = []
                for (let i = 0, len = tech.tech.length; i < len; i++) {
                    strings.push(tech.tech[i].name)
                    strings.push(tech.tech[i].description)
                    strings.push(tech.tech[i].requires)
                    allowConditions.push(tech.tech[i].allowed)
                    nonrefundJunk.push(tech.tech[i].isNonRefundable)
                    nonrefundJunk.push(tech.tech[i].isJunk)
                    nonrefundJunk.push(tech.tech[i].isFieldTech)
                    nonrefundJunk.push(tech.tech[i].isGunTech)
                    numbers.push(tech.tech[i].frequency)
                    numbers.push(tech.tech[i].frequencyDefault)
                    numbers.push(tech.tech[i].maxCount)
                    effects.push(tech.tech[i].effect)
                    effects.push(tech.tech[i].remove)
                }
                for (let i = 0, len = tech.tech.length; i < len; i++) {
                    let index = Math.floor(strings.length * Math.random())
                    tech.tech[i].name = strings[index]
                    strings.splice(index, 1)
                    index = Math.floor(strings.length * Math.random())
                    tech.tech[i].description = strings[index]
                    strings.splice(index, 1)
                    index = Math.floor(strings.length * Math.random())
                    tech.tech[i].requires = strings[index]
                    strings.splice(index, 1)
                    
                    index = Math.floor(allowConditions.length * Math.random())
                    tech.tech[i].allowed = allowConditions[index]
                    allowConditions.splice(index, 1)
                    
                    index = Math.floor(nonrefundJunk.length * Math.random())
                    tech.tech[i].isNonRefundable = nonrefundJunk[index]
                    nonrefundJunk.splice(index, 1)
                    index = Math.floor(nonrefundJunk.length * Math.random())
                    tech.tech[i].isJunk = nonrefundJunk[index]
                    nonrefundJunk.splice(index, 1)
                    index = Math.floor(nonrefundJunk.length * Math.random())
                    tech.tech[i].isFieldTech = nonrefundJunk[index]
                    nonrefundJunk.splice(index, 1)
                    index = Math.floor(nonrefundJunk.length * Math.random())
                    tech.tech[i].isGunTech = nonrefundJunk[index]
                    nonrefundJunk.splice(index, 1)
                    
                    index = Math.floor(numbers.length * Math.random())
                    tech.tech[i].frequency = numbers[index]
                    numbers.splice(index, 1)
                    index = Math.floor(numbers.length * Math.random())
                    tech.tech[i].frequencyDefault = numbers[index]
                    numbers.splice(index, 1)
                    index = Math.floor(numbers.length * Math.random())
                    tech.tech[i].maxCount = numbers[index]
                    numbers.splice(index, 1)
                    
                    index = Math.floor(effects.length * Math.random())
                    tech.tech[i].effect = effects[index]
                    effects.splice(index, 1)
                    index = Math.floor(effects.length * Math.random())
                    tech.tech[i].remove = effects[index]
                    effects.splice(index, 1)
                }
                strings = []
                allowConditions = []
        ...
        {
            name: "fork bomb",
            description: "get this <strong class='color-m'>tech</strong> twice",
            maxCount: Infinity,
            count: 0,
            frequency: 0,
            isNonRefundable: true,
        ...
        },
        {
            ...
            requires: "",
            effect() {
                setTimeout(()=>{m.death()},100)
            },
            remove() {}
        },
        {
            name: "discord moderator",
            description: "increase your <strong>maximum</strong> <strong class='color-h'>health</strong> by <strong>900</strong><br>instantly die on sun exposure",
            maxCount: 1,
            count: 0,
            frequency: 0,
            isNonRefundable: true,
            ...
            requires: "",
            effect() {
                tech.isDiscordModJunk = true
                m.maxHealth += 9
            },
            remove() {
                tech.isDiscordModJunk = false
            }
        },
        {
            name: "panpsychism",
        ...
        },
        {
            ...
            effect() {
                for (let i = 0, len = tech.tech.length; i < len; i++) {
                    if (tech.tech[i].isJunk) {
                        tech.tech[i].frequency = 2
                        tech.aproxJunkRatio = 12.3456789
                    } else {
                        tech.tech[i].frequency = 0
                    }
                }
        ...
        {
            name: "re-arm",
            description: "<strong class='color-remove'>remove</strong> all your <strong class='color-g'>guns</strong>,<br>and <strong>spawn</strong> new ones",
            maxCount: 9,
            count: 0,
            frequency: 0,
            isNonRefundable: true,
    ...
    isControlTheory: null,
    isInstability: null,
    isStability: null,
    isPhotodisintegration: null,
    isAbelian: null,
    isFermion: null,
    isMobDamageMACHO: null,
    isPullMACHO: null,
    isInvertMACHO: null,
    isDarkEnergy: null,
    isShotgunFlak: null,
