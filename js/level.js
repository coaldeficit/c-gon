...
const level = {
    ...
    gimmickLevels: ["run", "testChamber2", "temple", "biohazard", "stereoMadness"],
    ...
    laser(p1, p2, damage = 0.14, color = "#f00") {
        return {
            ...
            query() {
                ...
                best = vertexCollisionNew(this.position, this.look, m.isCloak ? [map, body] : [map, body, [playerBody, playerHead]]);
                // hitting player
